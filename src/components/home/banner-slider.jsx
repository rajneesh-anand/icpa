  ...
  return (
    <div>
      ...
      >
        <SwiperSlide>
          <Container>
            <div className="grid md:grid-cols-12 grid-cols-1 py-16 gap-8">
              <div className="md:col-span-6 md:text-left text-center">
                <div className="md:ml-8">
                  <div className="flex flex-col md:flex-row items-center">
                    <div className="mb-4 lg:mb-2 w-full shadow-dropDown bg-gradient-to-r from-red-600 to-amber-800  rounded-sm">
                    ...
                    <div className="mb-4 lg:mb-2 w-full shadow-dropDown bg-gradient-to-r from-amber-800 to-red-600  rounded-sm lg:ml-1">
                      <p className="uppercase transition-colors duration-300 px-6 md:px-3 py-2 font-semibold text-[12px] text-white ">
                  ...
                  <div className="mt-8">
                    <h1 className="font-noto uppercase text-slate-900 font-semibold text-3xl md:text-4xl md:!leading-[120%] lg:text-5xl max-w-4xl tracking-wide">
                  ...
                  <div className="mt-4">
                    <h1 className="text-slate-600 uppercase font-semibold text-xl md:text-2xl md:!leading-[120%] lg:text-2xl  max-w-4xl tracking-wide ">
                      Anytime &amp; Anywhere at{" "}
                      <span className="text-orange animate-pulse tracking-wide">
                        {" "}
                        Free of Cost
                      </span>
